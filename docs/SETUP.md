...
Part of the [Lattica](https://github.com/bitmosh) ecosystem. Each project is standalone — connection happens through data contracts and graph-native event emission, not runtime dependencies.
