# Cerebra — Per-Subsystem State Reports

Technical state snapshots per subsystem. Generated from implementation evidence rather than design docs, and updated as the codebase evolves. If any content here disagrees with the code, the code is correct — please open an issue.
...
**Version:** v0.4.5 | **Python:** ≥3.12 | **Entry point:** `cerebra.cli.main:cli`
