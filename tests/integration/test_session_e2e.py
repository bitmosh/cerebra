...
class TestSessionManagerLifecycle:
    def test_open_session_returns_active_session(
        ...
        s = manager.open_session(goal="test goal", cycle_config="default", vault_path=vault)
    ...
    def test_open_session_persisted(self, manager: SessionManager, vault: Path, db_path: Path) -> None:
        s = manager.open_session(goal="persist check", cycle_config="default", vault_path=vault)
    ...
    def test_open_session_emits_session_opened_event(
        ...
        s = manager.open_session(goal="emit check", cycle_config="default", vault_path=vault)
    ...
    def test_session_opened_stream_uses_session_id_as_cycle_id(
        ...
        s = manager.open_session(goal="stream check", cycle_config="default", vault_path=vault)
        events = store._store.read_range(
            ReadQuery(stream_id=f"cerebra/agent-trace/{s.session_id}")
        )
    ...
    def test_flush_session_marks_flushed(self, manager: SessionManager, vault: Path) -> None:
        s = manager.open_session(goal="flush test", cycle_config="default", vault_path=vault)
    ...
    def test_flush_session_updates_persisted_state(
        ...
        s = manager.open_session(goal="flush persist", cycle_config="default", vault_path=vault)
    ...
    def test_flush_already_flushed_raises(self, manager: SessionManager, vault: Path) -> None:
        s = manager.open_session(goal="double flush", cycle_config="default", vault_path=vault)
    ...
    def test_open_child_session_increments_depth(
        ...
        parent = manager.open_session(goal="parent", cycle_config="default", vault_path=vault)
        child = manager.open_session(
    ...
    def test_build_session_state_returns_state(
        ...
        s = manager.open_session(goal="state build", cycle_config="default", vault_path=vault)
...
class TestPredictInputFromSessionIntegration:
    def test_full_open_to_prediction_input(
        ...
        s = manager.open_session(goal="predict test", cycle_config="default", vault_path=vault)
        ss = manager.build_session_state(s.session_id)
    ...
    def test_prediction_input_session_id_matches_opened(
        ...
        s = manager.open_session(goal="id check", cycle_config="default", vault_path=vault)
        ss = manager.build_session_state(s.session_id)
